...
данные карточек публичного каталога. Audiomania читает JSON-LD только из
публичной категории «Виниловые пластинки» (`/vinilovye_plastinki/`):
оборудование и аксессуары не импортируются. Если публичный каталог отвечает
