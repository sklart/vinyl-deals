...
def test_critical_pressing_conflicts_never_auto_match():
    cases = [({"disc_count": 1}, {"disc_count": 2}), ({"format": "LP"}, {"format": '7"'}), ({"rpm": 33}, {"rpm": 45}), ({"vinyl_color": "black"}, {"vinyl_color": "red"}), ({"edition_tags": ("picture disc",)}, {"edition_tags": ()}), ({"edition_tags": ("deluxe",)}, {"edition_tags": ("box",)})]
