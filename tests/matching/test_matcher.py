...
def test_identical_barcodes_are_exact_unless_metadata_conflicts(): assert match_offers(offer(barcode="123"), offer(source_product_id="2", barcode="123")).kind == MatchKind.EXACT_BARCODE; assert match_offers(offer(barcode="123", disc_count=1), offer(source_product_id="2", barcode="123", disc_count=2)).kind == MatchKind.DIFFERENT
