...
def test_new_store_offers_share_release_and_search_selects_lowest_product_price(tmp_path) -> None:
    ...
    for source, product_id, price in (("audiomania", "AM-100", "5990"), ("respublica", "1544912", "5500"), ("drhead", "162248", "6200")):
        repository.upsert_offer(RawOffer(
            ...
            label="Music On Vinyl", release_year=2021, format="2LP", condition_media="NEW", price=Decimal(price), availability=Availability.IN_STOCK,
        ))
