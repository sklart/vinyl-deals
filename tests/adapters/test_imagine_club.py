...
def test_enriches_listing_from_product_fixture() -> None:
    ...
    assert (detail.catalog_number_raw, detail.label, detail.release_year, detail.condition_media, detail.condition_sleeve) == ("00-00002589", "Polydor", 1978, "EX", "VG+"); assert "Gatefold" in detail.edition_tags
