...
def main() -> int:
    ...
    scrape = commands.add_parser("scrape", help="Fetch a public store catalogue"); scrape.add_argument("source", choices=["vinyl_ru", "imagine_club", "collectomania", "rio_rostov", "audiomania", "respublica", "drhead", "droog_rostov"]); scrape.add_argument("--database", type=Path, default=Path("vinyl_deals.sqlite3")); scrape.add_argument("--page-limit", type=int, help="Temporary safe bound for a paginated source"); scrape.add_argument("--enrich", action="store_true", help="Fetch public product details for listed offers")
    ...
    if args.command == "search":
        ...
        for result in results:
            ...
            print()
        return 0
    factories = {"vinyl_ru": VinylRuAdapter, "rio_rostov": RioRostovAdapter, "audiomania": AudiomaniaAdapter, "respublica": RespublicaAdapter, "drhead": DrHeadAdapter, "droog_rostov": DroogRostovAdapter}
